...
public class ProtocolCard : Panel
{
    ...
    private static ProtocolCard? _currentlyExpanded;

    public ProtocolCard(EmergencyProtocol protocol)
    {
        _protocol = protocol;
    ...
    {
        new ProtocolViewerForm(_protocol).ShowDialog();
    }

    private Image LoadTransparentImage()
    {
        string path = "Protocol.png";
