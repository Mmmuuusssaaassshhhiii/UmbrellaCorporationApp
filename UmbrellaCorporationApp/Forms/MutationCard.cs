...
public class MutationCard : Panel
{
    ...
    private static MutationCard? _currentlyExpanded;

    public MutationCard(Mutation mutation)
    {
        _mutation = mutation;

        Size = new Size(170, _collapsedHeight);
        ...
        _title = new Label
        {
            Text = mutation.TestSubject?.Code ?? "UNKNOWN",
    ...
    {
        new MutationViewerForm(_mutation).ShowDialog();
    }

    private Image LoadTransparentImage()
    {
        string path = "Mutation.png";
